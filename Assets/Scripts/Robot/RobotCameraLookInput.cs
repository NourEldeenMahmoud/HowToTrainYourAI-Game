...
/// for the robot camera. Queries ControlManager each frame — no event-timing issues.
/// </summary>
[RequireComponent(typeof(CinemachineOrbitalFollow))]
public class RobotCameraLookInput : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (controlManager.IsInputLocked) return;

        // Don't orbit when cursor is visible (e.g. Robot Messages Canvas is open).
