...
public class ControlManager : MonoBehaviour
{
    ...
    [Header("Switch")]
    [SerializeField, Min(0f)] private float minSwitchInterval = 0.25f;
    ...
    {
        if (Time.unscaledTime < nextAllowedSwitchTime)
        {
            return;
        }
        ...
        if (messageBlocksPlayerControls && isPlayerControlActive)
        {
            ...
            ToggleControl();
            nextAllowedSwitchTime = Time.unscaledTime + minSwitchInterval;
            return;
        }
    ...
    public GameObject PlayerUiRoot => playerUiRoot;
    public GameObject RobotUiRoot => podUiRoot;
