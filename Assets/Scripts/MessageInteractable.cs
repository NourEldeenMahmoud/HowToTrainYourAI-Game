...
{
    public static event Action<MessageInteractable> AnyMessageOpened;
    public static event Action<MessageInteractable> AnyMessageClosed;

    public event Action<MessageInteractable> MessageOpened;
    public event Action<MessageInteractable> MessageClosed;

    public static bool HasOpenedAnyMessage { get; private set; }
    public static bool IsAnyMessageOpen => openMessageCount > 0;
    public bool IsMessageOpen => messageIsOpen;
    public GameObject MessageUiRoot => messageUiRoot;
    ...
    public void OpenMessage()
    {
        ...
        MessageOpened?.Invoke(this);
        AnyMessageOpened?.Invoke(this);
    }
